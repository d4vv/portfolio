...
export default function Contact({hoverEnter, hoverLeave}) {
  return (
    <>
      <Head>
        <title>Dawid Mejster Portfolio - Contact</title>
        <meta name="description" content="If you want to get in contact with me all you have to do is to do a call or write an email to me and see if I might be a good fit for your project." />
      </Head>
