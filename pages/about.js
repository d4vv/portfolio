...
export default function About() {
  ...
  return (
    <>
      <Head>
        <title>Dawid Mejster Portfolio - About</title>
        <meta name="description" content="Dawid Mejster is a UI/UX Designer located in Torun, Poland working remotely for clients nationally and internationally." />
      </Head>
